...
public class hd_fails_from_1
{
    public static void main(String[] args)throws IOException
    {
	if(args.length != 3 && args.length != 4)
	{
	    System.err.println("Usage: java hd_fails_from_1 [-v] file1 file2 failsIn1");
	    System.exit(1);
	}
	...
	BufferedReader file1 = openFileRead(args[args.length - 3]);
	BufferedReader file2 = openFileRead(args[args.length - 2]);
	int failsInFP = Integer.parseInt(args[args.length - 1]);
	...
	{
	    System.out.println("" + (float)totalFlips/failsInFP);
    ...
    // Only report 0 bits from pA not in pB 
