...
public class convertImageDecayToFlips
{
    public static void main(String[] args)throws IOException
    {
	if(args.length != 2 && args.length != 3)
	{
	    System.err.println("Usage: java convertImageDecayToFlips exactImage approximateImage");
	    System.exit(1);
	}
	...
	while((line1 = file1.readLine()) != (line2 = file2.readLine()))
	{
		...
		int fails = ~byteDiff(bytes1[b], bytes2[b]) & 0xFF;

		System.out.format("%02X", fails);
